...
{
    public class Bullet_Death : Entity
    {
        ...
        {
            base.Initialize();
            sparks = new Sprite(Manager.Graphics.LoadTexture("bullet_death"));

            sparks.Animations.AddSecuence("death", new Rectangle(0, 0, 110, 110), 20, 16, false);
            sparks.Animations.Play("death");
            sparks.OffSet = new Vector2(40, 40);

            death = new SoundPlayer(@"Audio\FX\bullet_death");
            death.Play();
